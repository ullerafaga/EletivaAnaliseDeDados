...
vistoriasTempoReal <- read.csv2('http://dados.recife.pe.gov.br/dataset/99eea78a-1bd9-4b87-95b8-7e7bae8f64d4/resource/73b79738-9e76-4d3d-a057-625bb62b4bba/download/sedec_vistorias_tempo_real.csv', sep = ';', encoding = 'UTF-8')

View(vistoriasTempoReal)

vistoriasTempoReal <- vistoriasTempoReal[-1,] #tirei o uico caso que tinha para poder incrementar

View(vistoriasTempoReal)

# carrega base de dados para atualização
vistoriasTempoRealNew <- read.csv2('http://dados.recife.pe.gov.br/dataset/99eea78a-1bd9-4b87-95b8-7e7bae8f64d4/resource/73b79738-9e76-4d3d-a057-625bb62b4bba/download/sedec_vistorias_tempo_real.csv', sep = ';', encoding = 'UTF-8')

# compara usando a chave primária
vistoriasTempoRealIncremento <- (!vistoriasTempoRealNew$vistoria_data %in% vistoriasTempoReal$vistoria_data)

View(vistoriasTempoRealIncremento)
