...
# lendo csv ####
acidentesTransitoRecife2015csv <- read.csv2('http://dados.recife.pe.gov.br/datastore/dump/db610fdc-18fa-41a1-9b26-72038c56ffc8?bom=True', sep = ',', encoding = 'UTF-8'
)
View(acidentesTransitoRecife2015csv)

# lendo xml, mesma base mas de um arquivo de tipo diferente, para fins didáticos ####
acidentesTransitoRecife2015xml <- xmlToDataFrame("http://dados.recife.pe.gov.br/datastore/dump/db610fdc-18fa-41a1-9b26-72038c56ffc8?format=xml")

View(acidentesTransitoRecife2015csv)

# lendo xlsx

USsenateUnpassedLegislation <- read_excel('petitions.xlsx', sheet=1) 
View(USsenateUnpassedLegislation)
