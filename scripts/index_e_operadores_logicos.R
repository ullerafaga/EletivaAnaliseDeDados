...
# exercício: Compartilhe com a gente um código criado por você em que você
#recupera ou identifica um dado ou informação usando indexação.Lembre-se de 
#compartilhar um link do github!!!

#identificarei um dado no dataframe nativo do R USArrests
View(USArrests)

#identificarei em quais casos a variável "assassinatos" (Murder) tem valor acima
# de 10
which(USArrests$Murder > 10)
